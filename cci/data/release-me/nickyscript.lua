...
idle_xml_name = 'NickyGhost Idle'
left_xml_name = 'NickyGhost Left'
down_xml_name = 'NickyGhost Down'
up_xml_name = 'NickyGhost Up'
right_xml_name = 'NickyGhost Right'
...
name_of_character_xml = 'nicky-rm'
name_of_character = 'nicky-rm'
name_of_notetype = 'Nicky Note'
name_of_notetype2 = 'Nicky Note' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
